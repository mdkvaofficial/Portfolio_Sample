    ...
    let benefits = [
        {
            ...
            description:
                "I taught myself to code using free online resources and absolutely fell in love with the creativity and problem solving that is involved in developing and engineering innovative new online experiences. ",
        },
        {
    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">M. Danyal</span>
                Kayani
                <br />Svelte-Kit
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
            <Step step={steps[0]}>
                <p>
                    ...
                    Ipsa eligendi nostrum suscipit recusandae labore officia a,
                    temporibus sapiente quidem, sit facilis, ratione possimus
                    provident.
                </p>
            </Step>
            <Step step={steps[1]}>
                <p>
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    Sequi, eveniet recusandae ipsum hic cumque molestias autem
                    aut quasi in maiores illum quam voluptatibus nulla?
                </p>
            </Step>
            <Step step={steps[2]}>
                <p>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                    Nulla expedita ullam laboriosam doloremque totam quis,
                    excepturi at. Eius placeat enim consequuntur sint, quisquam
                    ea?
                </p>
            </Step>
        </div>
